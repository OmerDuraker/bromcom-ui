...
class Button extends LitElement {
    ...
    render() {
        ...
        const { kind, size, outline, iconOnly } = this
        ...
        if (iconOnly) {
            return html`
                <button ?disabled="${this.disabled}" class="${classes}" @click="${this.handleClick}">
                    ${
        ...
        return html`
            <button ?disabled="${this.disabled}" class="${classes}" @click="${this.handleClick}">
                ${
                    this.icon && this.iconPosition == 'left' ? this.geticon() : ''
                }
                <slot></slot>
                ${
                    this.icon && this.iconPosition == 'right' ? this.geticon() : ''
                }
            </button>
        `
    }
